...
export type TblDeviceTokenCreationAttributes = Optional<TblDeviceTokenAttributes, TblDeviceTokenOptionalAttributes>;

export class TblDeviceToken extends Model<TblDeviceTokenAttributes, TblDeviceTokenCreationAttributes> implements TblDeviceTokenAttributes {
  activity!: string;
  activityProc?: string;
  appid!: string;
  deviceType!: string;
