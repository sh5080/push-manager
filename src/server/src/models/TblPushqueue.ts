...
export type TblPushqueueOptionalAttributes =
  | "androidSound"
  | "appId"
  | "customKey1"
  | "customKey2"
  ...
  | "title"
  | "token";
export type TblPushqueueCreationAttributes = Optional<
  TblPushqueueAttributes,
  TblPushqueueOptionalAttributes
>;

export class TblPushqueue
  extends Model<TblPushqueueAttributes, TblPushqueueCreationAttributes>
  implements TblPushqueueAttributes
{
  androidSound?: string;
  appId?: string;
  customKey1?: string;
