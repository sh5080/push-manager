...
export type TblPushsendOptionalAttributes =
  | "openDate"
  | "resultmsg"
  | "sendDate"
  | "token"
  | "tokenIdx";
export type TblPushsendCreationAttributes = Optional<
  TblPushsendAttributes,
  TblPushsendOptionalAttributes
>;

export class TblPushsend
  extends Model<TblPushsendAttributes, TblPushsendCreationAttributes>
  implements TblPushsendAttributes
{
  deviceType!: string;
  idx!: any;
  msgIdx!: any;
