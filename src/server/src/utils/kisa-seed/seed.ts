...
export class KISA_ENC_DEC {
  ...
  public static KISA_ENCRYPT: KISA_ENC_DEC = new KISA_ENC_DEC(KISA_ENC_DEC._KISA_ENCRYPT);
  public static KISA_DECRYPT: KISA_ENC_DEC = new KISA_ENC_DEC(KISA_ENC_DEC._KISA_DECRYPT);
}
...
export class KISA_SEED_INFO {
  ...
  public buffer: number[] = new Array(4).fill(0);
  public buffer_length: number = 0;
  public last_block: number[] = new Array(4).fill(0);
